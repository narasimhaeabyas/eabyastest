...
.config(function($stateProvider) {
    ...
    .state('site.mm_attendence', {
        url: '/mm_attendence',
        views: {
            'site': {
                templateUrl: 'core/components/attendence/templates/list.html',
                controller: 'mmAttendenceListCtrl'
            }
        }
    });
...
.run(function($mmEvents, mmCoreEventLogin, mmCoreEventSiteUpdated, mmCoreEventLogout, $mmAttendenceDelegate) {
